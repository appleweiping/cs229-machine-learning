# Cart-pole simulator provided with the CS229 PS4 control problem.
# The continuous dynamics (Euler integration) and the state discretization
# (get_state) are course-provided infrastructure and are used unmodified so
# that the learned MDP matches the assignment's environment exactly.
